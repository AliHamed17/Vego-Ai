...
* **Tests:** Current unsuppressed rerun on 2026-07-25: 108 passed in `VEGO-AI/tests`; 92 passed plus 7 subtests in `scripts/tests`; 41 passed in `tests/hlayer_offline`; the complete controlled/source/release gate passed.
