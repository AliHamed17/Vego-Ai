...
- Offline H-layer-track status: `yellow`; iterations 008/009 are accepted NEUTRAL and the separate conformance suite passes, while M-02..M-05 and iterations 010/011 remain blocked.
...
- Iteration 008 supports atomic offline-run/manifests and EXP-012 gate behavior; iteration 009 supports repaired ObservationRecord/metric semantics and Pareto reporting only; EXP-013..018 support scoped fixture checks only.
