...
| ISS-006 | 2026-06-12 | Codex | Medium | Open | M4B-1 memory-informed parallel comparison now has EXP-003 evaluation tooling, but no completed generalization-safe expert-label evaluation yet. | Fill the EXP-003 blind/full labeling sheet with at least 20 safe expert labels, rerun `.\scripts\build-exp003-error-analysis.ps1`, and do not claim accuracy improvement until evidence exists. |
