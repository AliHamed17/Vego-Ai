...
2. Review PR #7 for the visualizer model/result mismatch fix.
3. Add a separate research-health allowlist fix for the tracked dashboard generator.
...
6. Refresh the M1-M2-M3-M4A-M4B1 artifact package and manifest only after PR #6 / health follow-up decisions are settled.
