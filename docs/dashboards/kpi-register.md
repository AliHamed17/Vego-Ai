...
| Dashboard tracking health | Dashboard sources, Confluence builder wiring, config page slots, and generated outbox are verified. | `dashboard-health` passes after wiki outbox build. | Green | `.\scripts\dashboard-health.ps1 -RequireOutbox` on 2026-06-13 | Run after every meaningful dashboard/wiki update. |
...
| Live Confluence sync | Outbox generated; live write blocked by Atlassian Rovo cloud grant. | Confluence pages update live from outbox. | Blocked | `docs/agent-memory/issues.md` ISS-005, rechecked 2026-06-13 13:30 +03:00 | Grant Atlassian access to cloud `724252a1-a5b7-45a5-b6ec-27a8292197ec`. |
