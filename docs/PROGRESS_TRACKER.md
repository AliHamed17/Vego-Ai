...
<!-- AUTO:stamp:start -->
As of 2026-07-11 12:56 UTC · branch `agent/publish-hlayer-and-supervisor-package` · HEAD `134ce86` · evidence baseline commit `0976c05` · generated by `scripts/build-progress-tracker.py`
<!-- AUTO:stamp:end -->
...
> preparation. Twelve H-layer iterations are accepted; iteration 008 established atomic reliability, iteration 009 repaired offline contracts/metrics, iteration 010 is a reliability-only rerun, iteration 011 is feedback-generalization boundary protection, and iteration 012 is decision register synchronization. None selects a default.
...
| EXP-006–008 | observation contracts, dosage, trigger replay | iteration-009 repairs retained; iteration-012 reliability snapshot current | 501 ObservationRecords; Pareto/workload evidence only, no default |
