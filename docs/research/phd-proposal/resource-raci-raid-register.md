...
| ASM-02 | Assumption resolved | Wednesday 09:00–10:00 Asia/Jerusalem is the active weekly slot through the 2026-10-07 occurrence. | Recurring master event accepted by Ali, Iris, and Arnon | IRIS/ALI | Maintain recurrence and verify each meeting’s task/decision record separately. | Ongoing | Confirmed |
