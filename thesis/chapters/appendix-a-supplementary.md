...
16. Current verified inventory passes (111 VEGO-AI tests, 109 research-infrastructure tests plus 7 subtests, and 41 offline H-layer tests)
...
| Run test inventories | `python -m pytest VEGO-AI/tests scripts/tests tests/hlayer_offline -q` | 111 VEGO-AI tests, 109 research-infrastructure tests plus 7 subtests, and 41 offline H-layer tests pass |
