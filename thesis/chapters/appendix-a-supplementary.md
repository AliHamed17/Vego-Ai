...
16. Current verified inventory passes (108 VEGO-AI tests, 102 research-infrastructure tests plus 7 subtests, and 41 offline H-layer tests)
...
| Run test inventories | `python -m pytest VEGO-AI/tests scripts/tests tests/hlayer_offline -q` | 108 VEGO-AI tests, 102 research-infrastructure tests plus 7 subtests, and 41 offline H-layer tests pass |
