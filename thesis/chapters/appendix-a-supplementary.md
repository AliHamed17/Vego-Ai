...
16. Current verified inventory passes (106 VEGO-AI tests, 82 research-infrastructure tests plus 7 subtests, and 39 offline H-layer tests)
...
| Run test inventories | `python -m pytest VEGO-AI/tests scripts/tests tests/hlayer_offline -q` | 106 VEGO-AI tests, 82 research-infrastructure tests plus 7 subtests, and 39 offline H-layer tests pass |
