...
16. Current verified inventory passes (113 VEGO-AI tests, 113 research-infrastructure tests plus 7 subtests, and 46 offline H-layer tests)
...
| Run test inventories | `python -m pytest VEGO-AI/tests scripts/tests tests/hlayer_offline -q` | 113 VEGO-AI tests, 113 research-infrastructure tests plus 7 subtests, and 46 offline H-layer tests pass |
